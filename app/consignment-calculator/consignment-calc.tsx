...
function buildAltAuction(
  ...
  return {
    ...
    footnote:
      "Bonus is a percentage of the hammer price, not the buyer's total. Estimated using hammer as proxy for submission value at intake — actual bonus may differ. Card must be in Alt Vault.",
