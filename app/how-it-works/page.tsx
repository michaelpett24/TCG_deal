    ...
    <div className="page-wrap">
      ...
      <div className="hiw-step">
        ...
        <div className="hiw-body">
          ...
          <p>
            The <strong>position bar</strong> shows visually where the proposed price falls between the seller floor and buyer ceiling. A dot near the left edge means the deal heavily favors the buyer; near the right edge means it heavily favors the seller; near the center mark (even split) means both sides are getting a fair shake.
          </p>
          <p>
